...
class WebsocketClient(Websocket):
    ...
    def send_header(self,line):
        if __debug__: print("TX: '" + line + "'")
        self.sock.write(bytes(line + "\r\n", "UTF-8"))

#    def send(self,msg):
#        if __debug__: print("TX: '" + msg + "'")
#        self.ws.send(msg)
#
#    def recv(self):
#        msg = self.ws.recv()
#        if __debug__ and msg is not None: print("RX: '" + msg + "'")
#        return msg
    ...
    def readline(self):
        while True:
            ...
            if offset != -1:
                ...
                if __debug__: print("RX: '" + str(result) + "'")
                return result
